...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const openAppointmentForm = async (id = null) => {
        ...
        // Augment doctor list with display text
        const doctorsWithSpecialty = doctors.map(doc => ({
            ...doc,
            display_name: doc.specialty ? `${doc.name} (${doc.specialty})` : doc.name
        }));
